// let login ='', senha, article, div, h3, p1, input, p2, span, main, section, footer, h2, p3, span2, aLink, aLink2
// let usr = []
// let snh = []
// let produto = []
...
//     aLink.setAttribute('href', 'http://ww.amazon.com.br/' + link[i])
